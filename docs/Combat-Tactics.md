...
- The legacy Protector/Marksman boss-leashed bounded search does not emit another cover movement when the selected shooting cover is already inside the shared three-meter arrival-hold envelope. Balanced Rifleman search is authorized by the centralized engagement evaluation instead.
