...
namespace pitTeam.Patches
{
    internal static class PlayerVoicePhraseAvailability
    {
        ...
        public static bool TryGetContactAudioFallback(PhraseSpeakerClass speaker, out TagBank fallbackBank)
        {
            fallbackBank = null;
        ...
        private static bool HasPlayableBank(PhraseSpeakerClass speaker, EPhraseTrigger phrase)
        {
    ...
    internal sealed class PlayerContactAudioFallbackPatch : ModulePatch
    {
        protected override MethodBase GetTargetMethod()
        {
            return AccessTools.Method(
                ...
                nameof(PhraseSpeakerClass.Play),
